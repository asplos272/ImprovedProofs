...
proof (intro conjI)
 ...
 if "\<not> nextHTDDataPending ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) 0"
 using that apply (metis CSTATE_otherside_rule_5_0 C_msg_P_same_def FixISDData.device_perform_op_nextHTDDataPending i50 nextStore_otherside_rule_3_0)done
qed
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps2 assms i79 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_reqs2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i56 i81) done
  show goal44: "length (reqs1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqs1 assms i57 i81) done
  show goal45: "length (reqs2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqs2 i58) done
  show goal46: "length (snps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps2 assms i60 i79) done
  show goal47: "length (snps1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps1 i61) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i382 i614old i81) done
 ...
 by (metis FixISDData.device_perform_op_reqresps1 FixISDData.device_perform_op_snpresps2 FixISDData.device_perform_op_snps2 aux53 i1x i79)
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i616old i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 aux3_r42 i618old) done
  show goal57: "CSTATE Invalid ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) 0 \<longrightarrow> reqs1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) = []"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqs1 assms i81) done
  show goal58: "CSTATE Invalid ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) 1 \<longrightarrow> reqs2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) = []"
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqs2 i69) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqs2 i71) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_htddatas2 i78) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps1 FixISDData.device_perform_op_snpresps2 FixISDData.device_perform_op_snps2 assms i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i80 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqs2 i82) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending FixISDData.device_perform_op_reqs2 i84) done
  show goal76: "length (reqresps1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps1 assms i552 i57 i79 i81) done
  show goal77: "length (reqresps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps2 i86) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps2 assms i552 i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_reqs2 assms i81 i95) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqs2 FixISDData.device_perform_op_snpresps1 assms i81 i99) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_reqs2 assms i101 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_htddatas2 ISDData_HSTATE assms i108 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas2 ISDData_HSTATE assms i109 nextHTDDataPending_various_forms1) done
  show goal103: "length (dthdatas1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 i883) done
  show goal104: "length (dthdatas2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas2 i884) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_snpresps1 assms i118 i81) done
  show goal114: "snpresps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) \<noteq> [] \<longrightarrow> reqresps1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) = []"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps1 assms i79) done
  show goal115: "length (snpresps1 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps1 i120) done
  show goal116: "length (snpresps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ])) \<le> 1"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps2 assms i552 i60 i79) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_inequality_invariant FixISDData.device_perform_op_snpresps1 MESI_State.distinct(185) assms hstate_invariants(17) hstate_invariants(20) hstate_invariants(24) i2x i443 nextHTDDataPending_various_forms1 remove_instr_HSTATE) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_inequality_invariant FixISDData.device_perform_op_snpresps2 MESI_State.distinct(187) MESI_State.distinct(207) assms hstate_invariants(17) hstate_invariants(20) hstate_invariants(24) i2x i352 i452 remove_instr_HSTATE) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_snpresps1 ISDData_HSTATE assms i126 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps2 ISDData_HSTATE assms i127 nextHTDDataPending_various_forms1) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_snpresps2 ISDData_HSTATE assms i136 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas2 FixISDData.device_perform_op_snpresps1 ISDData_HSTATE assms i137 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps2 FixISDData.device_perform_op_snps2 assms i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i150 i81 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 ISDData_HSTATE assms i186 i591 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas2 ISDData_HSTATE assms i186 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE i182 i183 i220) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_dthdatas2 ISDData_HSTATE assms i186 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_dthdatas2 ISDData_HSTATE assms i455 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_nextHTDDataPending i191 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_dthdatas2 ISDData_HSTATE assms i194 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps1 assms i552 i79 i81) done
  show goal192: "snpresps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) \<noteq> [] \<longrightarrow> reqresps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) = []"
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps2 assms i79 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i317 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE i333 i334) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i342 i552 i79 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE i220 i332 i345) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending i353) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_assign_rule_6_flipped CSTATE_inequality_invariant CSTATE_otherside_rule_8 FixISDData.device_perform_op_dthdatas2 MESI_State.distinct(105) SharedSnpInv'_CSTATE_invariant5_2 SharedSnpInv'_MAD_CSTATE_invariant4 dthdatas1_general_rule_4_0 i190 i191 i2x i407 nextDTHDataFrom_def nextHTDDataPending_otherside_rule_2_0) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_otherside_rule_8 FixISDData.device_perform_op_dthdatas2 i436 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE assms i220 i353 i366 i367 i547 i643 i645 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_assign_rule_6 CSTATE_inequality_invariant CSTATE_otherside_rule_8 FixISDData.device_perform_op_dthdatas2 FixISDData.device_perform_op_htddatas2 HTDDataPending_htddatas_invariant2 MESI_State.distinct(3) SARspSFwdM_invariant2 i109 i2x i463 nextGOPending_DeviceISDData nextHTDDataPending_otherside_rule_2_0 nextHTDDataPending_various_forms1 nextHTDDataPending_various_forms2 nextSnpRespIs_general_rule_7_0 nextSnpRespIs_invariant_variant1 nextSnpRespIs_property2 nextSnpRespIs_remove_op)done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE assms aux_not_invalidM i220 i376 i383 i602 i603 i632) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 FixISDData.device_perform_op_snps2 assms i378 i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps1 assms i79 i81) done
  show goal267: "CSTATE Invalid ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) 1 \<longrightarrow> reqresps2 ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) = []"
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqresps2 assms i382 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 ISDData_nextSnoopIs assms i389 i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps1 ISDData_HSTATE i427 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqs1 ISDData_HSTATE assms i431 i81 i888 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_inequality_invariant FixISDData.device_perform_op_snpresps1 ISDData_HSTATE MESI_State.distinct(185) assms i443 i799 nextHTDDataPending_various_forms1) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_snpresps2 ISDData_HSTATE i444 i800 i890) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqs2 i488) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_reqresps2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i490 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i317 i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending i516 i914 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_otherside_rule_8 FixISDData.device_perform_op_htddatas2 HTDDataPending_htddatas_invariant2 assms i353 i469 i614 nextSnoopIs_general_rule_7_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i547) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i547 i904) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i367 i547) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i547 i553) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i547 i555) done
 ...
 apply  (insert assms)(**)apply (metis CSTATE_otherside_rule_5_0 FixISDData.device_perform_op_htddatas2 HTDDataPending_htddatas_invariant2 assms hstate_invariants(17) hstate_invariants(20) hstate_invariants(24) i353 i400 i596 i614 i636 nextSnoopIs_general_rule_7_0 remove_instr_HSTATE) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i552 i599 i79 i914 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i643 i645) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE i657 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE i659 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 FixISDData.device_perform_op_dthdatas2 i883 i884) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_dthdatas1 ISDData_HSTATE i709 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps1 FixISDData.device_perform_op_snps2 ISDData_HSTATE assms i714 i79 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_reqresps2 ISDData_HSTATE assms i718 i81 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps1 ISDData_HSTATE i734 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside CSTATE_inequality_invariant FixISDData.device_perform_op_snpresps1 ISDData_HSTATE MESI_State.distinct(133) i221 i738 i889) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside CSTATE_inequality_invariant FixISDData.device_perform_op_snpresps1 ISDData_HSTATE MESI_State.distinct(99) i221 i749 i889) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snpresps2 assms i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqresps2 assms i759 i81) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_inequality_invariant FixISDData.device_perform_op_snpresps1 ISDData_HSTATE MESI_State.distinct(185) assms i799 nextHTDDataPending_various_forms1) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_snpresps2 ISDData_HSTATE i800 i890) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps2 assms i79) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_snps1 ISDData_HSTATE i836 nextDTHDataFrom_general_rule_4_0) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_different1 FixISDData.device_perform_op_snpresps1 HSTATE_general_rule_5_0 MESI_State.distinct(185) i1x i2x i443 nextHTDDataPending_def) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_dthdatas2 assms i81 i898) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending assms i643 i902) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside CSTATE_inequality_invariant FixISDData.device_perform_op_nextHTDDataPending ISDData_nextSnoopIs MESI_State.distinct(187) assms i621 i924) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_nextHTDDataPending i930) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_htddatas2 FixISDData.device_perform_op_snpresps1 FixISDData.device_perform_op_snps1 assms i81 i932 nextGOPendingStateGeneral_rule_4_1 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) CSTATE_ISDData_otherside FixISDData.device_perform_op_reqs2 i942 nextGOPendingStateGeneral_rule_4_1 nextGOPending_DeviceISDData) done
 ...
 apply  (insert assms)(**)apply (smt (verit) FixISDData.device_perform_op_nextHTDDataPending ISDData_HSTATE i944 nextSnpRespIs_general_rule_7_0) done
...
qed
 ...
 by (smt (verit) FixISDData.device_perform_op_snps1 ISDData_HSTATE goal156 i963 nextDTHDataFrom_general_rule_4_0)
 ...
 by (smt (verit) FixISDData.device_perform_op_reqresps1 goal788 i1x i552 i79)
 ...
 by (metis FixISDData.device_perform_op_reqresps2 hstate_invariants(17) hstate_invariants(20) hstate_invariants(24) i965 nextDTHDataFrom_general_rule_4_0 remove_instr_HSTATE)
