...
proof (intro conjI)
  ...
  show goal210: "C_msg_P_same SIA (nextGOPendingIs GO_WritePullDrop) nextEvict ( T [ =hv v] [ 5 sHost= InvalidM] [ Dev1 -=d2hdHead ])"
    apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def)(**)apply (smt (verit) CSTATE_general_rule_2_0 HOST_State.distinct(245) HOST_State.distinct(247) HOST_State.distinct(305) HOST_State.distinct(307) HSTATE_invariant3 aux7062 i186 i189 i1x i225 i2x i328 i591 i960) done
