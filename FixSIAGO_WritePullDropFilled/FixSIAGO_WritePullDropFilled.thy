...
by presburger
have i221: "HSTATE InvalidM T \<or> HSTATE SharedM T \<or> HSTATE SB T \<or> HSTATE IB T \<or> HSTATE ModifiedM T"
...
HSTATE ModifiedM ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ]  [ -=i 0]) "
...
by (smt (verit) HOST_State.distinct(11) HOST_State.distinct(113) HOST_State.distinct(221) HOST_State.distinct(223) HOST_State.distinct(81) HSTATE_invariant4 i2201)
...
by (metis HOST_State.distinct(121) HOST_State.distinct(19) HOST_State.distinct(305) HOST_State.distinct(307) HOST_State.distinct(89) HSTATE_invariant4 aux2_r145 i221)
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (smt (verit) HOST_State.distinct(107) HOST_State.distinct(109) HOST_State.distinct(111) HOST_State.distinct(167) HOST_State.distinct(169) HOST_State.distinct(197) HOST_State.distinct(379) HOST_State.distinct(7) HOST_State.distinct(77) HOST_State.distinct(9) HSTATE_invariant3 i217 i2201) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i22 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (smt (verit) i217 i254 nextReqIs_not_various_forms1) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i217 i492 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms2 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis H_msg_P_oppo_def SIAGO_WritePullDrop_nextHTDDataPending_sameside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i13 i205 i2160 i254 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms1 remove_instr_HSTATE reqs1_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis assms i2160 i254 i343 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms1 nextSnpRespIs_property1 nextSnpRespIs_remove_op reqresps_empty_noGOPendingIs1 reqs1_remove_op snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis H_msg_P_same_def SIAGO_WritePullDrop_nextSnpRespIs_otherside assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i14 i15 i2160 i254 i343 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_general_rule_6_0 nextReqIs_not_various_forms1 nextReqIs_remove_op nextSnpRespIs_property1 remove_instr_HSTATE reqresps_empty_noGOPendingIs1 reqs1_remove_op snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (smt (verit) HOST_State.distinct(107) HOST_State.distinct(109) HOST_State.distinct(167) HOST_State.distinct(169) HOST_State.distinct(3) HOST_State.distinct(379) HOST_State.distinct(7) HOST_State.distinct(75) HOST_State.distinct(77) HSTATE_invariant3 i217 i2201) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i23 nextStore_otherside_rule_2_0 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_otherside_rule_4_0 CSTATE_remove_op HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i22 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
show goal21: "C_msg_not RdShared IMAD ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_inequality_invariant C_msg_not_def MESI_State.distinct(147) i2160 i25 i254 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms1 reqs1_remove_op) done
show goal22: "C_msg_not RdShared Invalid ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i254 i69 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms1 nextReqIs_not_various_forms2 reqs1_remove_op reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_inequality_invariant HSTATE_SIAGO_WritePullDrop_invariant Invalid_not_eq_MIA SIAGO_WritePullDrop_nextGOPendingIs_otherside i215 i2160 i221 i313 i579 i773 i800 i945 nextGOPendingIs_XYAGO_other1 reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1) done
show goal27: "C_state_not MIA RdShared ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_assign_rule_2 CSTATE_inequality_invariant C_state_not_def Invalid_not_eq_MIA i2160 i254 i31 i325 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms1 reqs1_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (smt (verit) CSTATE_different1 MESI_State.distinct(163) i216 i254 reqs1_empty_not_nextReqIs_general_invariant) done
show goal36: "C_msg_P_host Shared (nextSnoopIs SnpInv) (HSTATE MA) ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (smt (verit) aux562 empty_no_snoop_variant2 i214) done
show goal37: "C_msg_state RdShared ISAD ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 C_msg_state_def i205 i2160 i254 i47 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms1 reqs1_remove_op) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 SIAGO_WritePullDrop_nextHTDDataPending i207 i2160 i614old nextHTDDataPending_various_forms2 nextStore_otherside_rule_2_0) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis i211 i2160 i95 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceModifiedStore nextGOPending_yes_reqresp_rule_6_1 nextReqIs_SIAGO_WritePullDrop reqresps_empty_noGOPending2 reqs2_SIAGO_WritePullDrop reqs2_empty_not_nextReqIs_general_invariant reqs2_remove_op) done
...
apply  (insert assms) apply (metis i2160 i58 nextGOPendingIs_XYAGO_other1 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis HTDDataPending_htddatas_invariant1 assms htddatas1_general_rule_12_0 htddatas1_general_rule_4_0 i207 i214 i215 i2160 i316 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op snps2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (smt (verit) aux562) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 assms htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i213 i2160 i343 i618old nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i69 nextGOPendingIs_XYAGO_other1 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i71 nextGOPendingIs_XYAGO_other1 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i75 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i259 i752old nextGOPendingIs_XYAGO_other1 nextLoad_DeviceSIAGO_WritePullDrop) done
...
apply  (insert assms) apply (smt (verit) aux2_r113 aux3_r113 i207 i883 nextHTDDataPending_various_forms1) done
show goal69: "length (htddatas2 ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])) \<le> 1"
apply  (insert assms) apply (metis htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i2160 i78 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 assms i213 i2160 i343 i80 nextGOPendingIs_XYAGO_other1 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i82 nextGOPendingIs_XYAGO_other1 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis i2160 i86 nextGOPendingIs_XYAGO_other1 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 assms htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i213 i2160 i343 i587 nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i92 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
show goal84: "C_msg_P_same MIA (nextReqIs DirtyEvict) nextEvict ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis SIAGO_WritePullDrop_nextEvict_otherside i2160 i255 i543 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis i2160 i95 nextSnoopPending_empty_not_rule_4_0 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis assms i2160 i343 nextSnoopPending_empty_not_rule_4_0 reqresps_empty_noGOPendingIs1 reqs2_SIAGO_WritePullDrop snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_different1 MESI_State.distinct(385) assms aux1_103p i187 i1x i316 i416 i493 i580 i581 i745 i750 i828 i855 i894 i896 i954 nextHTDDataPending_various_forms1 nextHTDDataPending_various_forms2 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i813 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i813 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(109) HOST_State.distinct(121) HOST_State.distinct(167) HOST_State.distinct(169) HOST_State.distinct(19) HOST_State.distinct(287) HOST_State.distinct(307) HOST_State.distinct(7) HOST_State.distinct(77) HOST_State.distinct(87) HSTATE_invariant3 i2201) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux562 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i107 i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) aux3_r113 aux5_r113 aux_r113) done
...
apply  (insert assms) apply (metis dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i2160 i884 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant SARspSFwdM_invariant2 SIAGO_WritePullDrop_nextSnpRespIs_otherside assms i2160 i316 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i458 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis assms i2160 i343 nextSnoopPending_empty_not_rule_4_0 reqresps2_SIAGO_WritePullDrop reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis assms i2160 i343 le0 list.size(3) nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
show goal116: "length (snpresps2 ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])) \<le> 1"
apply  (insert assms) apply (metis assms i2160 i316 le0 list.size(3) nextGOPendingIs_XYAGO_other1 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextSnpRespIs_sameside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i441 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SARspSFwdM_invariant2 assms i2160 i316 nextGOPendingIs_XYAGO_other1 nextSnpRespIs_remove_op snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) htddatas2_SIAGO_WritePullDrop i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux2_r145 dthdatas2_SIAGO_WritePullDrop hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis assms htddatas2_SIAGO_WritePullDrop i2160 i343 nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis assms htddatas1_SIAGO_WritePullDrop i2160 i316 nextSnoopPending_empty_not_rule_4_1 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis assms htddatas2_SIAGO_WritePullDrop i2160 i343 nextSnoopPending_empty_not_rule_4_0 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE reqs2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i131 i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis assms dthdatas2_SIAGO_WritePullDrop i2160 i343 nextSnoopPending_empty_not_rule_4_0 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_otherside_rule_4_0 CSTATE_remove_op HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i144 i2160 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceSIAGO_WritePullDrop_other remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i146 i2160 i259 nextGOPendingIs_XYAGO_other1 nextLoad_DeviceSIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis assms i213 i2160 i343 nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i954 nextGOPendingIs_XYAGO_other1 nextGOPending_yes_reqresp_rule_4_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_disj1 HSTATE_SIAGO_WritePullDrop_invariant HSTATE_rule_2 MESI_State.distinct(385) MESI_State.distinct(43) MESI_State.distinct(505) MESI_State.distinct(575) i1x i316 i418 nextGOPendingIs_XYAGO_other1 nextHTDDataPending_various_forms1) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux_r154 dthdatas1_general_rule_1_0 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux_r154 dthdatas2_SIAGO_WritePullDrop hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis assms i2160 i316 i343 nextSnoopPending_empty_not_rule_4_1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i160 i2160 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_IXADGO_invariant1 nextDTHDataFrom_general_rule_10_0 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(107) HOST_State.distinct(109) HOST_State.distinct(167) HOST_State.distinct(169) HOST_State.distinct(287) HOST_State.distinct(3) HOST_State.distinct(7) HOST_State.distinct(75) HOST_State.distinct(77) HOST_State.distinct(87) HSTATE_invariant3 i2201) done
...
apply  (insert assms) apply (metis hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i164 i2160 nextDTHDataFrom_general_rule_1_0 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i166 i2160 nextDTHDataFrom_general_rule_1_0 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE reqs2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i577 i593 i665 i677 i680 i703 i770 i772 i773 i774 i954 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i221 i313 i579 i800 nextGOPendingIs_XYADGO_agnostic1 nextGOPendingIs_XYAGO_other1 nextGOPendingIs_remove_op remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextGOPendingIs_otherside assms aux172 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i181 i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant HTDDataPending_htddatas_invariant2 aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i183 i2160 nextGOPendingIs_XYAGO_other1 nextHTDDataPending_remove_op nextHTDDataPending_various_forms2 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant assms aux172 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux3_r113 aux5_r113 aux_r113 dthdatas1_general_rule_1_0 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i186 i2160 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux3_r113 aux5_r113 aux_r113 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i189 i2160 nextSnoopPending_empty_not_rule_4_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux3_r113 aux5_r113 aux_r113 dthdatas1_general_rule_1_0 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i459 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HTDDataPending_htddatas_invariant1 SIAGO_WritePullDrop_nextHTDDataPending dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op htddatas1_general_rule_12_0 i191 i207 i2160 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_def nextHTDDataPending_def) done
...
apply  (insert assms) apply (smt (verit) aux2_r113 aux5_r113 nextDTHDataFrom_def) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(109) HOST_State.distinct(121) HOST_State.distinct(167) HOST_State.distinct(169) HOST_State.distinct(19) HOST_State.distinct(305) HOST_State.distinct(307) HOST_State.distinct(7) HOST_State.distinct(77) HOST_State.distinct(89) HSTATE_invariant3 i2201) done
...
apply  (insert assms) apply (metis assms i2160 i316 nextSnoopPending_empty_not_rule_4_0 reqresps2_SIAGO_WritePullDrop snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextGOPendingIs_otherside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i863 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextGOPendingIs_otherside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i215 i2160 i313 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis SIAGO_WritePullDrop_nextGOPendingIs_otherside i215 i2160 i95 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1 reqresps_empty_noGOPendingIs2 reqs2_empty_not_nextReqIs_general_invariant) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 assms htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i213 i2160 i317 i343 nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 C_msg_P_same_def SIAGO_WritePullDrop_nextEvict_otherside SIAGO_WritePullDrop_nextGOPendingIs_otherside i215 i2160 i324 nextGOPendingIs_XYAGO_other1 reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i220 i334 nextGOPendingIs_XYAGO_other1 nextHTDDataPending_remove_op remove_instr_HSTATE xyad_go_invariant2) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i340 nextStore_otherside_rule_2_0) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant HTDDataPending_htddatas_invariant2 aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) htddatas2_SIAGO_WritePullDrop htddatas2_remove_op i2160 i345 nextGOPendingIs_XYAGO_other1 nextHTDDataPending_remove_op nextHTDDataPending_various_forms2 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i346 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceSIAGO_WritePullDrop_other remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i348 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceSIAGO_WritePullDrop_other remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i350 nextStore_otherside_rule_2_0) done
show goal235: "C_msg_P_same IMA nextGOPending nextStore ( T\<lparr>buffer1 := Some m\<rparr> [ 0 s= Invalid] [ 0 -=reqresp ] [ -=i 0])"
apply  (insert assms , unfold SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i211 i2160 i371 nextStore_otherside_rule_2_0) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 SIAGO_WritePullDrop_nextHTDDataPending i2160 i353 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis CSTATE_otherside_rule_4_0 CSTATE_remove_op HSTATE_SIAGO_WritePullDrop_invariant aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i358 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceSIAGO_WritePullDrop_other remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) CSTATE_inequality_invariant MESI_State.distinct(139) MESI_State.distinct(149) MESI_State.distinct(151) MESI_State.distinct(169) MESI_State.distinct(171) aux562 aux581 i207 i211 i216 i217) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_remove_op SIAGO_WritePullDrop_nextHTDDataPending aux3_r113 aux5_r113 aux_r113 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i2160 i407 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i2160 i438 i763 nextGOPendingIs_XYAGO_other1 nextGOPending_yes_reqresp_rule_4_1 reqresps_empty_noGOPending2) done
...
apply  (insert assms) apply (smt (verit) CSTATE_inequality_invariant MESI_State.distinct(139) MESI_State.distinct(143) MESI_State.distinct(145) aux581 i216) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i146 i2160 i259 i369 i752old nextGOPendingIs_XYAGO_other1 nextLoad_DeviceSIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_otherside_rule_4_0 CSTATE_otherside_rule_7 CSTATE_remove_op i2160 i340 i350 i371 nextStore_otherside_rule_2_0) done
...
apply  (insert assms) apply (smt (verit) aux562 aux581 i207 i211) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 SIAGO_WritePullDrop_nextHTDDataPending assms aux2_r145 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i2160 i217 i316 i467 nextGOPendingIs_XYAGO_other1 nextGOPending_yes_reqresp_rule_4_1 nextSnpRespIs_invariant2) done
...
apply  (insert assms) apply (metis CSTATE_otherside_rule_4_0 CSTATE_remove_op HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i221 i675 i751 i768 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i2201 i774 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 assms i213 i214 i2160 i343 i378 nextGOPendingIs_XYAGO_other1 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i382 nextGOPendingIs_XYAGO_other1 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i393 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis assms i2160 i316 i343 nextSnoopPending_empty_not_rule_4_0 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom2_XYAGO1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis assms i2160 i316 nextDTHDataFrom2_XYAGO1 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis assms i2160 i343 nextDTHDataFrom2_XYAGO1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i844 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE reqs2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE reqs1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i843 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 remove_instr_HSTATE reqresps2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis assms htddatas2_SIAGO_WritePullDrop i2160 i316 nextGOPendingIs_XYAGO_other1 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant SARspSFwdM_invariant1 SIAGO_WritePullDrop_nextSnpRespIs_sameside assms i2160 i343 nextSnpRespIs_general_rule_4_0 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant SIAGO_WritePullDrop_nextSnpRespIs_otherside assms i2160 i316 nextGOPendingIs_XYAGO_other1 nextSnpRespIs_invariant2) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(107) HOST_State.distinct(111) HOST_State.distinct(119) HOST_State.distinct(17) HOST_State.distinct(197) HOST_State.distinct(287) HOST_State.distinct(289) HOST_State.distinct(379) HOST_State.distinct(87) HOST_State.distinct(9) HSTATE_invariant4 i2201) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i492 nextGOPendingIs_XYAGO_other1 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux562 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i679 i680 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i499 i69 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop reqs2_SIAGO_WritePullDrop reqs2_empty_not_nextReqIs_general_invariant reqs2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i501 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux562 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i514 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_inequality_invariant CSTATE_remove_op aux562 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i107 i2160 i217 i252 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i518 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 SIAGO_WritePullDrop_nextHTDDataPending i2160 i520 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceSIAGO_WritePullDrop_other) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i947 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis SIAGO_WritePullDrop_nextEvict_otherside i2160 i566 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i568 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i664 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis SIAGO_WritePullDrop_nextEvict_otherside i2160 i543 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (smt (verit) aux581 i207) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i561 i947 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(105) HOST_State.distinct(119) HOST_State.distinct(121) HOST_State.distinct(17) HOST_State.distinct(19) HOST_State.distinct(287) HOST_State.distinct(289) HOST_State.distinct(305) HOST_State.distinct(307) HOST_State.distinct(87) HSTATE_invariant3 i2201) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i570 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 C_msg_state_def i2160 i47 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_assign_rule_2 CSTATE_disj1 CSTATE_otherside_rule_2_0 MESI_State.distinct(149) MESI_State.distinct(151) MESI_State.distinct(169) MESI_State.distinct(171) hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i577 i675 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i207 i211 i2160 i671 i677 i915 nextGOPendingIs_XYAGO_other1 nextGOPending_yes_reqresp_rule_4_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending assms aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i183 i2160 i345 i585 i813 nextGOPendingIs_XIAGOWPD_otherside1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i215 i2160 i313 i579 i800 nextGOPendingIs_XYADGO_agnostic1 nextGOPendingIs_XYAGO_other1 nextGOPendingIs_remove_op remove_instr_HSTATE reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis aux3_r113 aux5_r113 aux_r113 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i595 nextSnoopPending_empty_not_rule_4_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) CSTATE_different1 MESI_State.distinct(139) aux581 i216) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i607 i667 i675 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i609 i667 i675 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i577 i611 i675 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i915 i917 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) aux581) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant HSTATE_XYAGO1 aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i657 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i659 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i661 nextGOPendingIs_XYAGO_other1 nextGOPending_yes_reqresp_rule_4_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i663 nextGOPendingIs_XYAGO_other1 nextGOPending_yes_reqresp_rule_4_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_assign_rule_2 CSTATE_inequality_invariant HSTATE_SIAGO_WritePullDrop_invariant Invalid_not_eq_MIA hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i665 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_disj1 HSTATE_SIAGO_WritePullDrop_invariant HSTATE_XYAGO1 MESI_State.distinct(139) MESI_State.distinct(151) MESI_State.distinct(171)) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i667 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i669 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceSIAGO_WritePullDrop_other remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i671 nextGOPendingIs_XYAGO_other1 nextGOPending_DeviceModifiedStore nextGOPending_yes_reqresp_rule_6_1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i915 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) CSTATE_different1 MESI_State.distinct(149) MESI_State.distinct(169) aux581 i216) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i675 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i677 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i679 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i680 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 assms i213 i2160 i343 i763 nextGOPendingIs_XYAGO_other1 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux562 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i703 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i705 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_general_rule_6_0 nextReqIs_remove_op remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i217 i706 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis aux3_r113 aux5_r113 aux_r113 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i2160 i883 i884 list.size(3) nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i721 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_IXADGO_invariant1 nextDTHDataFrom_general_rule_10_0 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis assms dthdatas2_SIAGO_WritePullDrop hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i721 nextDTHDataFrom_general_rule_1_0 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis assms dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i186 i189 i2160 i221 i595 i721 i725 nextDTHDataFrom_general_rule_1_0 nextSnoopPending_empty_not_rule_4_0 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis assms dthdatas2_SIAGO_WritePullDrop hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i813 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i722 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_IXADGO_invariant1 nextDTHDataFrom_general_rule_10_0 remove_instr_HSTATE reqresps2_SIAGO_WritePullDrop reqresps2_remove_op) done
...
apply  (insert assms) apply (metis assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i813 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE reqresps2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i726 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 remove_instr_HSTATE reqresps2_SIAGO_WritePullDrop reqresps2_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i728 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_otherside_rule_4_0 CSTATE_remove_op HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i730 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 aux562 i2160 i71 lastSharer_non_Invalid_rule_2_0 nextReqIs_SIAGO_WritePullDrop reqs2_SIAGO_WritePullDrop reqs2_empty_not_nextReqIs_general_invariant reqs2_remove_op) done
...
apply  (insert assms) apply (metis assms i2160 i316 nextGOPendingIs_XYAGO_other1 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis assms i2160 i316 nextSnoopPending_empty_not_rule_4_0 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op) done
...
apply  (insert assms) apply (metis assms i2160 i343 nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 aux1_103p i2160 i750 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant aux581 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i751 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i763 nextGOPendingIs_XYAGO_other1 reqresps2_SIAGO_WritePullDrop reqresps2_remove_op) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i725 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i768 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i770 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i772 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_inequality_invariant HSTATE_SIAGO_WritePullDrop_invariant Invalid_not_eq_MIA hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i773 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i207 i2160 i774 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i777 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i778 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 remove_instr_HSTATE reqresps2_SIAGO_WritePullDrop reqresps2_remove_op) done
...
apply  (insert assms) apply (metis aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextSnoopPending_empty_not_rule_4_0 remove_instr_HSTATE snps1_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis assms i214 i215 i2160 i316 nextGOPendingIs_XYAGO_other1 snpresps2_SIAGO_WritePullDrop snpresps2_remove_op snps2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SARspSFwdM_invariant1 assms i2160 i343 nextGOPendingIs_XYAGO_other1 reqresps_empty_noGOPendingIs1 snpresps1_SIAGO_WritePullDrop snpresps1_remove_op) done
...
apply  (insert assms) apply (smt (verit) aux562 i217) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i215 i2160 i800 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i721 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_general_rule_1_0 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_inequality_invariant HSTATE_SIAGO_WritePullDrop_invariant Invalid_not_eq_MIA hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i945 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 i2160 i492 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextReqIs_not_various_forms2 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (smt (verit) aux562 aux581) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextGOPendingIs_otherside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i215 i2160 i863 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE reqresps1_SIAGO_WritePullDrop_aux1 reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i876 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_assign_rule_2 CSTATE_inequality_invariant HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextGOPendingIs_otherside assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i381 i877 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(119) HOST_State.distinct(121) HOST_State.distinct(17) HOST_State.distinct(19) HOST_State.distinct(267) HOST_State.distinct(287) HOST_State.distinct(289) HOST_State.distinct(307) HOST_State.distinct(85) HOST_State.distinct(87) HSTATE_invariant4 i2201) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 dthdatas2_SIAGO_WritePullDrop dthdatas2_remove_op i2160 i898 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant SIAGO_WritePullDrop_nextSnpRespIs_otherside assms i2160 i316 nextGOPendingIs_XYAGO_other1 nextSnpRespIs_property2) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant aux_r154 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom1_XYAGO1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_disj1 HSTATE_SIAGO_WritePullDrop_invariant MESI_State.distinct(167) SIAGO_WritePullDrop_CSTATE_aux SharedSnpInv'_CSTATE_invariant5 i2160 i915 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_disj1 HSTATE_SIAGO_WritePullDrop_invariant MESI_State.distinct(167) SIAGO_WritePullDrop_CSTATE_aux SharedSnpInv'_CSTATE_invariant5 i2160 i916 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(115) HOST_State.distinct(121) HOST_State.distinct(13) HOST_State.distinct(19) HOST_State.distinct(245) HOST_State.distinct(247) HOST_State.distinct(287) HOST_State.distinct(289) HOST_State.distinct(83) HOST_State.distinct(87) HSTATE_invariant3 i2201) done
...
apply  (insert assms) apply (metis SIAGO_WritePullDrop_nextSnpRespIs_otherside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i919 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_otherside_invariant2 SIAGO_WritePullDrop_nextHTDDataPending i2160 i930 nextGOPendingIs_XYAGO_other1) done
...
apply  (insert assms) apply (metis aux_r154 dthdatas2_SIAGO_WritePullDrop hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextGOPending_overlooked_reqresp_rule_4_0 remove_instr_HSTATE) done
...
apply  (insert assms) apply (smt (verit) HOST_State.distinct(111) HOST_State.distinct(119) HOST_State.distinct(17) HOST_State.distinct(195) HOST_State.distinct(197) HOST_State.distinct(287) HOST_State.distinct(289) HOST_State.distinct(79) HOST_State.distinct(87) HOST_State.distinct(9) HSTATE_invariant4 i2201) done
...
apply  (insert assms) apply (metis i2160 i95 nextGOPending_DeviceModifiedStore nextGOPending_overlooked_reqresp_rule_4_0 nextGOPending_yes_reqresp_rule_6_1 reqresps_empty_noGOPending2 reqs2_SIAGO_WritePullDrop reqs2_remove_op) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant SIAGO_WritePullDrop_nextHTDDataPending SIAGO_WritePullDrop_nextSnpRespIs_otherside hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i944 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant CSTATE_SIAGO_WritePullDrop_otherside_invariant2 CSTATE_inequality_invariant HSTATE_SIAGO_WritePullDrop_invariant Invalid_not_eq_MIA hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i945 nextGOPendingIs_XYAGO_other1 remove_instr_HSTATE) done
...
apply  (insert assms) apply (metis CSTATE_SIAGO_WritePullDrop_IMAD_invariant SIAGO_WritePullDrop_nextSnpRespIs_otherside assms i2160 i316 nextDTHDataFrom2_XYAGO1 nextSnpRespIs_property2) done
...
apply  (insert assms) apply (metis SIAGO_WritePullDrop_nextSnpRespIs_otherside assms i2160 i316 nextGOPendingIs_XYAGO_other1 nextReqIs_SIAGO_WritePullDrop nextSnpRespIs_property2) done
...
apply  (insert assms) apply (metis aux2_r145 hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 nextDTHDataFrom2_XYAGO1 remove_instr_HSTATE reqresps2_SIAGO_WritePullDrop) done
...
apply  (insert assms) apply (metis HSTATE_SIAGO_WritePullDrop_invariant assms hstate_invariants(14) hstate_invariants(2) hstate_invariants(24) i2160 i777 nextDTHDataFrom2_XYAGO1 nextDTHDataFrom_IXADGO_invariant1 nextDTHDataFrom_general_rule_10_0 remove_instr_HSTATE reqresps_empty_noGOPendingIs1) done
