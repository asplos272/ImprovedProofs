...
apply  (insert assms)
by (metis CSTATE_ISDData_otherside CSTATE_inequality_invariant ISDData_HSTATE MESI_State.distinct(253) MESI_State.distinct(3) device_perform_op_dthdatas2 device_perform_op_nextHTDDataPending i221 i436 i463 i79 nextGOPending_DeviceISDData nextSnpRespIs_invariant2)
